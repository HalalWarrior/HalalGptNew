    ...
    <div className={`flex w-full mb-6 ${isModel ? 'justify-start' : 'justify-end'}`}>
      <div className={`flex max-w-[85%] md:max-w-[75%] gap-3 ${isModel ? 'flex-row' : 'flex-row-reverse'}`}>
        ...
        <div className={`flex flex-col ${isModel ? 'items-start' : 'items-end'}`}>
          <div
            className={`px-5 py-3.5 rounded-2xl shadow-sm text-sm leading-relaxed overflow-hidden ${
              isModel
          ...
          >
            ...
            {!isModel && message.attachment && (
              <div className="mb-3 rounded-lg overflow-hidden border border-emerald-500/30">
                <img 
            ...
            {isModel && message.generatedImage && (
              <div className="mb-3 rounded-lg overflow-hidden border border-slate-200 shadow-sm">
                 <img 
